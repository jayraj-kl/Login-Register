...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Size = System::Drawing::Size(156, 48);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Email :";
			// 
			// tbEmail
			// 
			this->tbEmail->Location = System::Drawing::Point(177, 137);
			this->tbEmail->Name = L"tbEmail";
			this->tbEmail->Size = System::Drawing::Size(670, 55);
			...
			this->label3->Size = System::Drawing::Size(236, 48);
			this->label3->TabIndex = 3;
			this->label3->Text = L"Password :";
			// 
			// tbPassword
			// 
			this->tbPassword->Location = System::Drawing::Point(243, 245);
			this->tbPassword->Name = L"tbPassword";
			this->tbPassword->PasswordChar = '*';
			this->tbPassword->Size = System::Drawing::Size(604, 55);
			...
			this->btnOK->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnOK->Location = System::Drawing::Point(223, 405);
			this->btnOK->Name = L"btnOK";
			this->btnOK->Size = System::Drawing::Size(193, 83);
			...
			this->btnCancel->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btnCancel->Location = System::Drawing::Point(493, 405);
			this->btnCancel->Name = L"btnCancel";
			this->btnCancel->Size = System::Drawing::Size(193, 83);
			...
			this->llRegister->Location = System::Drawing::Point(650, 503);
			this->llRegister->Name = L"llRegister";
			this->llRegister->Size = System::Drawing::Size(197, 48);
			...
			this->ClientSize = System::Drawing::Size(859, 560);
...
#pragma endregion
	...
	private: System::Void btnOK_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		try {
			String^ connString = "Data Source=localhost\\sqlexpress;Initial Catalog=banking;Integrated Security=True";
			SqlConnection sqlConn(connString);
			sqlConn.Open();

			String^ sqlQuery = "SELECT * FROM bankinfo WHERE email=@email AND password=@pwd;";
